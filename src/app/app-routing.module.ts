...
const routes: Routes = [
  ...
  // { path: 'dtc-careers', loadChildren: () => import('./dtc-careers/dtc-careers.module').then( m => m.DtcCareersPageModule) },
  ...
  // { path: 'indicators', loadChildren: () => import('./indicators/indicators.module').then( m => m.IndicatorsPageModule) },
  // { path: 'tracing', loadChildren: () => import('./tracing/tracing.module').then( m => m.TracingPageModule) },
];
